...
#[component]
pub fn Hero(contact: Vec<ContactEntry>) -> impl IntoView {
    view! {
        <section id="hero" class="section fade-in">
            <div class="container">
                <h1 class="hero-name">"Moaz bin Mokhtar"</h1>
                <p class="hero-tag">"Software Engineer"</p>
                <p class="hero-role">"Rust" "\u{00a0}\u{00a0}·\u{00a0}\u{00a0}" "React" "\u{00a0}\u{00a0}·\u{00a0}\u{00a0}" "Python"</p>
                <div id="hero-links" class="hero-links">
                    {contact
                        .into_iter()
                        .map(|entry| {
